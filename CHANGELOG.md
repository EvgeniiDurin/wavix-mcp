...
- 123+ auto-generated tools from OpenAPI specification
- Documentation resources (97 files) for API and product documentation
- 31 prompts for common operations and code integration
