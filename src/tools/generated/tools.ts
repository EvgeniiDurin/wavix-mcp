...
export const generatedTools: Tool[] = [
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: countries (Get a list of countries), regions (Get a list of regions, requires: country), cities (Get a list of cities in a country, requires: country), region_cities (Get a list of cities in a region, requires: country, region), available (Get numbers available for purchase, requires: country, city)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: get (Get cart content), update (Add phone numbers to the cart, requires: ids), clear (Remove numbers from the cart), checkout (Check out numbers, requires: ids)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: list (Get CDRs on the account, requires: from, to, type), list_all (Get CDRs in NDJSON format, requires: from, to, type), get (Get details of a specific call, requires: uuid), export (Search for calls containing specific keywords or phrases, requires: type, from, to, page, per_page), retranscribe (Transcribe a single call, requires: cdr_uuid), transcription (Request transcription for a specific call, requires: cdr_uuid)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: list (List call recordings), get (Get a specific call recording, requires: cdr_uuid), delete (Delete a specific recording, requires: id)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: create (Upload a file for transcription), get (Query a specific transcription, requires: uuid), update (Retranscribe an uploaded file, requires: uuid, callback_url), download (Retrieve the original file, requires: uuid)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: get (List configured webhooks), create (Create a webhook, requires: url, event_type), delete (Delete a webhook, requires: event_type)"
        }
      },
      "required": [
        "action"
  ...
  {
    "name": "calls",
    "description": "Control calls: initiate calls, list active calls, get call details, answer, hangup, play audio, collect DTMF, manage streams",
    "inputSchema": {
      "type": "object",
      "properties": {
        "from": {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: list (Get active widget tokens), create (Generate a Wavix Embeddable Widget token, requires: sip_trunk), get (Get a Wavix Embeddable Widget token, requires: uuid), update (Update a widget token payload, requires: uuid, payload), delete (Delete a Wavix Embeddable Widget token, requires: uuid)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: send (Send SMS or MMS message, requires: from, to, message_body), list (Get messages on your account, requires: type), list_all (Get messages in NDJSON format, requires: type), get (Get a specific message, requires: id), opt_out (Unsubscribe a phone number from SMS messages, requires: opt_out)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: list (List Sender IDs), create (Create a new Sender ID, requires: sender_id, type, countries, usecase), get (Get a Sender ID, requires: id), delete (Delete a Sender ID, requires: id)"
        }
      },
      "required": [
        "action"
  ...
  {
    "name": "10dlc_brands",
    "description": "Manage 10DLC brands: register/update brands, manage evidence documents, request vetting, check use case eligibility",
    "inputSchema": {
      "type": "object",
      "properties": {
        "dba_name": {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: list (Validate a single phone number, requires: phone_number, type), create (Validate multiple phone numbers, requires: phone_numbers, type, async, force), get (Get asynchronous validation results, requires: uuid)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: create (Trigger a scenario, requires: voice_campaign), get (Get a specific voice campaign, requires: id)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: create (Create a short link, requires: link), metrics (Get metrics for short links, requires: from, to)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: transactions (Get transactions on the account, requires: from_date, to_date), invoices (Get statements on the account), invoice_download (Download a statement, requires: id)"
        }
      },
      "required": [
        "action"
  ...
  {
    "name": "profile",
    "description": "Manage account profile. Actions: get (profile info: name, email, company), update (modify profile), config (account balance and limits)",
    "inputSchema": {
      "type": "object",
      "properties": {
        "additional_info": {
        ...
        "action": {
          ...
          "description": "Action to perform: get (Get customer info), update (Update customer info), config (Get account settings)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: list (Get sub-accounts), create (Create a new sub-account, requires: name), get (Get a specific sub-account, requires: id), update (Update a sub-account, requires: id, name), transactions (List transactions for a sub-account, requires: id, from_date, to_date)"
        }
      },
      "required": [
        "action"
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "action": {
          ...
          "description": "Action to perform: get_api_url (Manage configuration), set_api_url (Manage configuration, requires: url)"
        }
      },
      "required": [
        "action"
